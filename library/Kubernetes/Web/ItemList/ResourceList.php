...
class ResourceList extends ItemList
{
    ...
    public function setViewMode(string $mode): self
    {
        switch ($mode) {
            case 'minimal':
                $this->setItemLayoutClass(ResourceMinimalItemLayout::class);

                break;
            case 'detailed':
                $this->setItemLayoutClass(ResourceDetailedItemLayout::class);

                break;
            case 'common':
                $this->setItemLayoutClass(ResourceDefaultItemLayout::class);
    ...
    protected function createListItem(object $data): ListItem
    {
        ...
        $this->setDetailUrl(Factory::createDetailUrl($data->getTableName()));
