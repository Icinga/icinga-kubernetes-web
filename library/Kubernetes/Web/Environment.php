...
class Environment extends BaseHtmlElement
{
    ...
    protected Query|null $parents;

    protected Query|null $children;

    protected mixed $parentsFilter;

    protected mixed $childrenFilter;
     ...
     * @param mixed|null $childrenFilter The filer for children
     */
    ...
    private function createSummary(Model $node, HtmlElement $list, bool $forParents = false): void
    {
        ...
        } elseif (! $forParents && $list->count() > 2) {
            $list->addHtml(
                new HtmlElement(
                    'li',
                    null,
